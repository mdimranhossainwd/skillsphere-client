      ...
      >
        {course.map((item) => (
          <div key={item._id} className="my-6">
            ...
            <div className="px-2">
              <h2 className="text-md w-56 mt-2 font-bold">
                {item?.course_Name}
              </h2>
              ...
              <div className="flex items-center mt-4">
                ...
                <div>
                  <p className="text-sm ml-3">({item?.course_TotalStudents})</p>
                </div>
              </div>
              <h4 className="text-lg font-bold mt-1">${item?.course_Amount}</h4>
            </div>
          </div>
        ))}
      </Carousel>
